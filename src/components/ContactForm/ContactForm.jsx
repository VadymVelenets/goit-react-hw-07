    ...
    <Formik
      ...
      onSubmit={(e, { resetForm }) => {
        dispatch(
          ...
          .unwrap()
          .then(() => {
            toast.success("The contact has been successfully added to the list!");
          });
        resetForm();
      }}>
      <Form className={css.form}>
        ...
        <ErrorMessage className={css.error} name="name" component="p"></ErrorMessage>

        <label className={css.label} htmlFor={idNumber}>
          Number
        </label>
        <Field className={css.field} id={idNumber} name="number" />
        <ErrorMessage className={css.error} name="number" component="p"></ErrorMessage>
